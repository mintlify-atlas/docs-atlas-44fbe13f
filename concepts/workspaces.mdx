---
title: Workspaces
description: Learn about niri's dynamic workspace system that moves between monitors
---
...
<Accordion title="Emulating Static Workspaces">
...
<Tip>
Actively move workspaces up and down as you're working on things to make what you need accessible in one motion.

For example, if you frequently switch between the browser and whatever you're doing, move whatever you're currently doing to right below the browser, so a single `focus-workspace-up/down` gets you where you want.
</Tip>